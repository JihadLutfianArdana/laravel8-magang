    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title">
                <a href="/dashboard/absensi-admin/{{ $absensi->user_id }}" class="btn mb-1 btn-secondary">
                    <i class="bi bi-arrow-left"></i> Kembali
                </a>
            </div>
            <form action="/dashboard/absensi-admin/{{ $absensi->id }}/update" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
