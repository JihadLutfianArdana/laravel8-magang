    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title">
                <a href="/dashboard/kegiatan-admin" class="btn mb-1 btn-secondary">
            ...
            <div class="d-flex mb-3">
                ...
                <form id="absenKeluarForm" action="/dashboard/absensi-admin/keluar/{{ $user_id }}" method="POST"
                    style="display: none;">
                    @csrf
                </form>
                <a href="/dashboard/absensi-admin/{{ $user_id }}/print" class="btn btn-dark">
                    ...
                    <tbody>
                        @foreach ($absensiPeserta as $absen)
                            <tr>
                                ...
                                {{-- <td>
                                    <a href="/dashboard/absensi-admin/{{ $absen->id }}/edit"
                                        class="btn btn-warning btn-sm">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <form action="/dashboard/absensi-admin/{{ $absen->id }}" method="POST"
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form action="/dashboard/absensi-admin/{{ $absen->id }}/delete-foto"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/dashboard/absensi-admin/store/{{ $user_id }}" method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <select id="status" name="status" class="form-control @error('status') is-invalid @enderror"
                                required onchange="toggleAdditionalInputs(this)">
