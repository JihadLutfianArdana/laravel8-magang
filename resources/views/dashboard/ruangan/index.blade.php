...
@section('container')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <a href="/dashboard/data-ruangan/create" class="btn mb-2 btn-success"><i class="bi bi-plus-circle"></i>
                Tambah
                Data Ruangan</a>
                    ...
                    <tbody>
                        @foreach ($ruangans as $key => $ruangan)
                            <tr>
                                ...
                                <td>
                                    <!-- Tombol Aksi -->
                                    <a href="/dashboard/data-ruangan/{{ $ruangan->nip }}/edit"
                                        class="btn btn-sm btn-warning"><i class="bi bi-pencil"></i> Edit</a>
                                    <form id="delete-Form-{{ $ruangan->nip }}"
                                        action="/dashboard/data-ruangan/{{ $ruangan->nip }}" method="POST"
                                        class="d-inline">
                                        @csrf
                                        @method('DELETE')
