            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title">
                        <a href="/dashboard/data-ruangan/admin-pendaftaran" class="btn mb-1 btn-secondary"><i
                                class="bi bi-arrow-left"></i>
                            Kembali</a>
                    </div>
                    <div class="form-validation">
                        <form class="form-valide" action="/dashboard/data-ruangan/admin-pendaftaran/{{ $ruangan->nip }}"
                            method="POST">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="nip" id="nip"
                                        ...
                                        value="{{ old('nip', $ruangan->nip) }}" required>
                                    @error('nip')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="nama_pegawai" id="nama_pegawai"
                                        ...
                                        value="{{ old('nama_pegawai', $ruangan->nama_pegawai) }}" required>
                                    @error('nama_pegawai')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <select name="nama_ruangan" id="nama_ruangan"
                                        ...
                                        <option value="-"
                                            {{ old('nama_ruangan', $ruangan->nama_ruangan) == '-' ? 'selected' : '' }}>-
                                        </option>
                                        <option value="Ruang Kepala Bapelkes"
                                            {{ old('nama_ruangan', $ruangan->nama_ruangan) == 'Ruang Kepala Bapelkes' ? 'selected' : '' }}>
                                            Ruang Kepala Bapelkes</option>
                                        <option value="Ruang Seksi Penyelenggara Pelatihan"
                                            {{ old('nama_ruangan', $ruangan->nama_ruangan) == 'Ruang Seksi Penyelenggara Pelatihan' ? 'selected' : '' }}>
                                            Ruang Seksi Penyelenggara Pelatihan</option>
                                        <option value="Ruang Seksi Pengendalian Mutu"
                                            {{ old('nama_ruangan', $ruangan->nama_ruangan) == 'Ruang Seksi Pengendalian Mutu' ? 'selected' : '' }}>
                                            Ruang Seksi Pengendalian Mutu</option>
                                        <option value="Ruang TU"
                                            {{ old('nama_ruangan', $ruangan->nama_ruangan) == 'Ruang TU' ? 'selected' : '' }}>
                                            Ruang TU</option>
                                        <option value="Ruang TU Perencanaan"
                                            {{ old('nama_ruangan', $ruangan->nama_ruangan) == 'Ruang TU Perencanaan' ? 'selected' : '' }}>
                                            Ruang TU Perencanaan</option>
                                        <option value="Ruang TU Bendahara Barang"
                                            {{ old('nama_ruangan', $ruangan->nama_ruangan) == 'Ruang TU Bendahara Barang' ? 'selected' : '' }}>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <select name="jabatan" id="jabatan"
                                        ...
                                        <option value="-"
                                            {{ old('jabatan', $ruangan->jabatan) == '-' ? 'selected' : '' }}>-</option>
                                        <option value="KADIS Bapelkes"
                                            {{ old('jabatan', $ruangan->jabatan) == 'KADIS Bapelkes' ? 'selected' : '' }}>
                                            KADIS Bapelkes</option>
                                        <option value="KASI Penyelenggara Pelatihan"
                                            {{ old('jabatan', $ruangan->jabatan) == 'KASI Penyelenggara Pelatihan' ? 'selected' : '' }}>
                                            KASI Penyelenggara Pelatihan</option>
                                        <option value="KASI Pengendalian Mutu"
                                            {{ old('jabatan', $ruangan->jabatan) == 'KASI Pengendalian Mutu' ? 'selected' : '' }}>
                                            KASI Pengendalian Mutu</option>
                                        <option value="KASI Tata Usaha"
                                            {{ old('jabatan', $ruangan->jabatan) == 'KASI Tata Usaha' ? 'selected' : '' }}>
                                            KASI Tata Usaha</option>
                                        <option value="KASI Tata Usaha (Perencanaan)"
                                            {{ old('jabatan', $ruangan->jabatan) == 'KASI Tata Usaha (Perencanaan)' ? 'selected' : '' }}>
                                            KASI Tata Usaha (Perencanaan)</option>
                                        <option value="KASI Tata Usaha (Bendahara Barang)"
                                            {{ old('jabatan', $ruangan->jabatan) == 'KASI Tata Usaha (Bendahara Barang)' ? 'selected' : '' }}>
                                            KASI Tata Usaha (Bendahara Barang)</option>
                                        <option value="Staff"
                                            {{ old('jabatan', $ruangan->jabatan) == 'Staff' ? 'selected' : '' }}>Staff
                                        </option>
                                    </select>
                                    @error('jabatan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <select name="peran_khusus" id="peran_khusus"
                                        ...
                                        <option value="-"
                                            {{ old('peran_khusus', $ruangan->peran_khusus) == '-' ? 'selected' : '' }}>-
                                        </option>
                                        <option value="Pembimbing Lapangan"
                                            {{ old('peran_khusus', $ruangan->peran_khusus) == 'Pembimbing Lapangan' ? 'selected' : '' }}>
                                            Pembimbing
                                            Lapangan</option>
                                    </select>
                                    @error('peran_khusus')
