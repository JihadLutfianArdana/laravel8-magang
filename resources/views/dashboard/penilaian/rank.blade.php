    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-start mt-3 mb-4">
                <a href="/dashboard/penilaian-akhir" class="btn btn-secondary">
            ...
            {{-- Form pilih periode --}}
            <form method="GET" action="/dashboard/penilaian-akhir/peringkat-peserta">
            ...
            @if ($selectedPeriode == 'semua')
                ...
                <div class="d-flex justify-content-start align-items-center mb-4 flex-wrap gap-2">
                    <a href="/dashboard/penilaian-akhir/laporan-perangkingan-peserta-terbaik?tanggal_awal={{ request('tanggal_awal') }}&tanggal_akhir={{ request('tanggal_akhir') }}"
                    ...
                    <tbody>
                        @foreach ($pesertaTerbaik as $index => $peserta)
                            <tr>
                                ...
                                @if ($nilaiSudahAda && $selectedPeriode != 'semua')
                                    <td>
                                        <a href="/dashboard/penilaian-akhir/peringkat-peserta/{{ $peserta->id }}?periode={{ $selectedPeriode }}"
