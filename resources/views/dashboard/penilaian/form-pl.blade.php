...
@section('container')
    <h2 class="mb-4">Form Penilaian Peserta Magang</h2>
    <hr class="my-4">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="card-title">
                <a href="/dashboard/penilaian-akhir/pembimbing-lapangan" class="btn mb-1 btn-secondary"><i
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="/dashboard/penilaian-akhir/form-penilaian/pembimbing-lapangan/{{ $user->id }}"
                method="POST">
                @csrf
