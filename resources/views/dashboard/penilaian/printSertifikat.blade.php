...
<body>
    <div class="certificate-container">
        ...
        <div class="certificate-header">
            ...
            <h1>SERTIFIKAT MAGANG : {{ $nomor_sertifikat }}</h1>
            <p>Dengan bangga kami sampaikan apresiasi ini kepada:</p>
        </div>

        <div class="certificate-body mt-3">
            <p style="font-size: 40px;"><strong>{{ strtoupper($nama_peserta) }}</strong></p>
            <hr style="width: 50%; margin: 0 auto; border: 1px solid #000;">
            <p>Atas partisipasi dan dedikasi dalam program magang, yang berlangsung dari:</p>
            <p>
            ...
            <p>Terima kasih atas kontribusi luar biasa dalam mendukung kesuksesan program ini.</p>
        </div>
