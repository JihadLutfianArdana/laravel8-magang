    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-start mt-4">
                <a href="/dashboard/penilaian-akhir/peringkat-peserta" class="btn btn-success">
                            ...
                            <tr class="text-center">
                                ...
                                <td class="text-center">
                                    @if ($sudahDinilai)
                                        ...
                                        <form method="POST" action="/dashboard/penilaian-akhir"
                                ...
                                <td class="text-center">
                                    <a href="/dashboard/penilaian-akhir/form-penilaian/{{ $user->id }}"
                                        class="btn btn-success mb-2">
                                        <i class="bi bi-trophy btn-sm"></i> Penilaian Kinerja
                                    </a>
                                    <a href="/dashboard/penilaian-akhir/cetak-penilaian/{{ $user->id }}"
                                        class="btn btn-dark">
                                        <i class="bi bi-printer btn-sm"></i> Cetak Penilaian
                                    </a>
                                </td>
                            </tr>
                        @endforeach
    ...
    <div class="card mt-3">
        <div class="card-body">
            ...
            <div class="d-flex align-items-center gap-3 mb-3">
                <a href="/dashboard/penilaian-akhir/laporan-sertifikat-magang/cetak?tanggal_awal_sertifikat={{ request('tanggal_awal_sertifikat') }}&tanggal_akhir_sertifikat={{ request('tanggal_akhir_sertifikat') }}"
                    ...
                    <tbody>
                        @foreach ($daftarSertifikat as $i => $sertifikat)
                            <tr>
                                ...
                                <td>
                                    <a href="/dashboard/penilaian-akhir/sertifikat/{{ $sertifikat->detailMagang->user_id }}"
                                        class="btn btn-dark" target="_blank">
