...
@section('container')
            ...
            <form action="#" method="POST"> {{-- Ganti action & method jika ingin diproses --}}
                ...
                <ol>
                    ...
                    <li class="d-flex justify-content-between align-items-center">
                        ...
                        {{-- <strong>{{ $penilaian->nilai_sikap ?? '-' }}</strong> --}}
    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="card-title">
                <a href="/dashboard/penilaian-akhir" class="btn mb-1 btn-secondary"><i class="bi bi-arrow-left"></i>
                    Kembali</a>
                {{-- @if ($penilaian && $penilaian->is_penilaian_selesai)
                    <a href="/dashboard/penilaian-akhir/sertifikat/{{ $user->id }}" class="btn mb-1 btn-dark">
    ...
    {{-- <div class="card">
        <div class="card-body">
            ...
            @php
                $jumlahHadir = $absensiPeserta->where('status', 'Hadir')->count();
                if ($jumlahHadir == 0) {
                    $nilaiKehadiran = 0;
                } elseif ($jumlahHadir < 20) {
                    $nilaiKehadiran = 50;
                } else {
                    $nilaiKehadiran = 80;
                }

                // Logika untuk kegiatan magang
                $jumlahKegiatan = $kegiatanMagang->count();
                if ($jumlahKegiatan == 0) {
                    $nilaiKegiatan = 0;
                } elseif ($jumlahKegiatan < 20) {
                    $nilaiKegiatan = 50;
                } else {
                    $nilaiKegiatan = 80;
                }
            ...
            <form action="/dashboard/penilaian-akhir/form-penilaian/{{ $user->id }}" method="POST">
                @csrf
                <input type="hidden" name="user_id" value="{{ $user->id }}">

                <h4 class="card-title">Input Penilaian Kinerja</h4>

                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="nilai_kehadiran" class="form-label">Absensi Kehadiran</label>
                            <input type="number"
                                class="form-control rounded @error('nilai_kehadiran') is-invalid @enderror"
                                id="nilai_kehadiran" name="nilai_kehadiran" placeholder="Masukkan nilai (1-100)"
                                value="{{ old('nilai_kehadiran', $penilaian->nilai_kehadiran ?? $nilaiKehadiran) }}"
                                required>
                        ...
                        <div class="mb-3">
                            <label for="nilai_kegiatan" class="form-label">Mengisi Logbbok Kegiatan</label>
                            <input type="number" class="form-control rounded @error('nilai_kegiatan') is-invalid @enderror"
                                id="nilai_kegiatan" name="nilai_kegiatan" placeholder="Masukkan nilai (1-100)"
                                value="{{ old('nilai_kegiatan', $penilaian->nilai_kegiatan ?? $nilaiKegiatan) }}" required>
                        ...
                        <div class="mb-3">
                            <label for="nilai_sikap" class="form-label">Mengikuti Aturan Yang Diberikan</label>
                            <input type="number" class="form-control rounded @error('nilai_sikap') is-invalid @enderror"
                                id="nilai_sikap" name="nilai_sikap" placeholder="Masukkan nilai (1-100)"
                                value="{{ old('nilai_sikap', $penilaian->nilai_sikap ?? '') }}" required>
                            @error('nilai_sikap')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="nilai_kedisiplinan" class="form-label">Disiplin Waktu</label>
                            <input type="number"
                                class="form-control rounded @error('nilai_kedisiplinan') is-invalid @enderror"
                                id="nilai_kedisiplinan" name="nilai_kedisiplinan" placeholder="Masukkan nilai (1-100)"
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="nilai_komunikasi" class="form-label">Membangun Komunikasi Dengan Sesama</label>
                            <input type="number"
                                class="form-control rounded @error('nilai_komunikasi') is-invalid @enderror"
                                id="nilai_komunikasi" name="nilai_komunikasi" placeholder="Masukkan nilai (1-100)"
                                value="{{ old('nilai_komunikasi', $penilaian->nilai_komunikasi ?? '') }}" required>
                        ...
                        <div class="mb-3">
                            <label for="nilai_tanggung_jawab" class="form-label">Tanggung Jawab Terhadap Tugas</label>
                            <input type="number"
                                class="form-control rounded @error('nilai_tanggung_jawab') is-invalid @enderror"
                                id="nilai_tanggung_jawab" name="nilai_tanggung_jawab"
                                placeholder="Masukkan nilai (1-100)"
                                value="{{ old('nilai_tanggung_jawab', $penilaian->nilai_tanggung_jawab ?? '') }}"
                                required>
                        ...
                        <div class="mb-3">
                            <label for="nilai_kerjasama" class="form-label">Kerjasama Tim</label>
                            <input type="number"
                                class="form-control rounded @error('nilai_kerjasama') is-invalid @enderror"
                                id="nilai_kerjasama" name="nilai_kerjasama" placeholder="Masukkan nilai (1-100)"
                                value="{{ old('nilai_kerjasama', $penilaian->nilai_kerjasama ?? '') }}" required>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control rounded @error('komentar') is-invalid @enderror" id="komentar" name="komentar"
                        rows="4" placeholder="Berikan komentar atau catatan tambahan">{{ old('komentar', $penilaian->komentar ?? '') }}</textarea>
                    @error('komentar')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
