...
@section('container')
            ...
            <div class="card-body">
                ...
                <div class="row mb-3 align-items-start">
                    ...
                    <div class="col-md-4 text-end">
                        <a href="/dashboard/penilaian-pembimbing" class="btn btn-secondary me-2">
                            <i class="bi bi-arrow-left"></i> Kembali
                        </a>
                        <a href="/dashboard/penilaian-pembimbing/{{ $user->id }}/cetak" class="btn btn-dark"
                            target="_blank">
    ...
    @else
        <div class="card mb-4">
            <div class="card-body">
                <a href="/dashboard/penilaian-pembimbing" class="btn btn-secondary">
                    <i class="bi bi-arrow-left"></i> Kembali
                </a>
