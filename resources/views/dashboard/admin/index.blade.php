                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="listAdmin" role="tabpanel">
                        <div class="p-t-3">
                            ...
                            <a href="/dashboard/kelola-pengguna/print" class="btn mb-3 btn-dark">
                                <i class="bi bi-printer"></i> Pimpinan
                            </a>
                            <a href="/dashboard/kelola-pengguna/printAP" class="btn mb-3 btn-dark">
                                <i class="bi bi-printer"></i> Admin Pendaftaran
                            </a>
                            <a href="/dashboard/kelola-pengguna/printPL" class="btn mb-3 btn-dark">
                                <i class="bi bi-printer"></i> Pembimbing Lapangan
                            </a>
                            <a href="/dashboard/kelola-pengguna/printPS" class="btn mb-3 btn-dark">
                                    ...
                                    <tbody>
                                        @foreach ($admins as $admin)
                                            <tr>
                                                ...
                                                <td>
                                                    @if (in_array($admin->is_admin, [2, 3, 0]))
                                                        <form id="delete-Form-{{ $admin->id }}"
                                                            action="/dashboard/kelola-pengguna/{{ $admin->id }}"
                    ...
                    <div class="tab-pane fade" id="addAdmin" role="tabpanel">
                        <div class="p-t-15">
                            ...
                            <form action="/dashboard/kelola-pengguna" method="POST">
                                @csrf
                                <div class="row">
