                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="laporanKegiatan" role="tabpanel">
                        ...
                        <div class="d-flex justify-content-start align-items-center mb-3">
                            <a href="/dashboard/laporan-kegiatan-peserta/pembimbing-lapangan?tanggal_awal_kegiatan={{ request('tanggal_awal_kegiatan') }}&tanggal_akhir_kegiatan={{ request('tanggal_akhir_kegiatan') }}"
                                class="btn btn-dark">
                                <i class="bi bi-printer"></i> Cetak Data
                            </a>
                            <form action="/dashboard/laporan-peserta/pembimbing-lapangan" method="GET"
                                class="form-inline">
                    ...
                    <div class="tab-pane fade" id="laporanAbsensi" role="tabpanel">
                        ...
                        <div class="d-flex justify-content-start align-items-center mb-3">
                            <a href="/dashboard/laporan-absensi-peserta/pembimbing-lapangan?tanggal_awal_absensi={{ request('tanggal_awal_absensi') }}&tanggal_akhir_absensi={{ request('tanggal_akhir_absensi') }}"
                                class="btn btn-dark">
                                <i class="bi bi-printer"></i> Cetak Data
                            </a>
                            <form action="/dashboard/laporan-peserta/pembimbing-lapangan" method="GET"
                    ...
                    <div class="tab-pane fade" id="laporanPenilaian1" role="tabpanel">
                        ...
                        <div class="d-flex justify-content-start align-items-center mb-3">
                            <a href="/dashboard/laporan-penilaian-peserta/pembimbing-lapangan?tanggal_awal_penilaian={{ request('tanggal_awal_penilaian') }}&tanggal_akhir_penilaian={{ request('tanggal_akhir_penilaian') }}"
                                class="btn btn-dark">
                                <i class="bi bi-printer"></i> Cetak Data
                            </a>
                            <form action="/dashboard/laporan-peserta/pembimbing-lapangan" method="GET"
                    ...
                    <div class="tab-pane fade" id="laporanPenilaian2" role="tabpanel">
                        ...
                        <div class="d-flex justify-content-start align-items-center mb-3">
                            <a href="/dashboard/laporan-penilaian-pembimbing/pembimbing-lapangan?tanggal_awal_penilaian_pembimbing={{ request('tanggal_awal_penilaian_pembimbing') }}&tanggal_akhir_penilaian_pembimbing={{ request('tanggal_akhir_penilaian_pembimbing') }}"
                                class="btn btn-dark">
                                <i class="bi bi-printer"></i> Cetak Data
                            </a>
                            <form action="/dashboard/laporan-peserta/pembimbing-lapangan" method="GET"
