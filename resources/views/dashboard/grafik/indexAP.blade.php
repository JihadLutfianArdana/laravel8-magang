...
@section('container')
    <h2 class="mb-4">Grafik Penerimaan Magang</h2>
    <hr class="my-4">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-start align-items-center mb-3">
                <a href="/dashboard/grafik-penerimaan/print/admin-pendaftaran?tanggal_awal={{ request('tanggal_awal') }}&tanggal_akhir={{ request('tanggal_akhir') }}"
    ...
    <div class="card mt-3">
        <div class="card-body">
            ...
            <!-- Form filter tahun dengan tampilan quixlab -->
            <div class="d-flex justify-content-start align-items-center mb-3">
                <a href="/dashboard/grafik-penerimaan-tahunan/print/admin-pendaftaran?tahun={{ $filterTahun }}"
                    target="_blank" class="btn btn-dark">
...
@section('scripts')
    ...
    <style>
        /* Atur tinggi grafik agar tidak terlalu besar */
        #distributed-series.ct-chart {
            min-height: auto !important;
            height: 250px !important;
        }

        /* Opsional: Hilangkan padding bawah dari card-body */
        .card-body {
