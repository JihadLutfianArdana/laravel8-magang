...
@section('container')
    <h2 class="mb-4">Edit Data Kegiatan</h2>
    <hr class="my-4">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-validation">
                        <form action="/dashboard/kegiatan/{{ $kegiatan->id }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group row">
                                <label for="dok_kegiatan" class="col-lg-4 col-form-label">Dokumentasi Kegiatan</label>
                                <div class="col-lg-6">
                                    <div class="custom-file">
                                        <input type="file"
                                            class="custom-file-input @error('dok_kegiatan') is-invalid @enderror"
                                            id="dok_kegiatan" name="dok_kegiatan" onchange="updateFileName()">
