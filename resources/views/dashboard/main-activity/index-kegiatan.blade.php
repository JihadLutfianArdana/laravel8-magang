    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title">
                <a href="/dashboard/kegiatan-admin" class="btn mb-1 btn-secondary"><i class="bi bi-arrow-left"></i></i>
                    Kembali</a>
            </div>
            @if (session('success'))
            ...
            <a href="/dashboard/kegiatan-admin/print/{{ $user->id }}" class="btn mb-2 btn-dark">
                        ...
                        @foreach ($kegiatanMagang as $key => $kegiatan)
                            <tr>
                                    ...
                                    <div class="modal fade" id="revisiModal{{ $kegiatan->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form
                                                    action="/dashboard/kegiatan-admin/kegiatan-magang/{{ $kegiatan->id }}/revisi"
                                                    method="POST">
                                                    @csrf
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <textarea class="form-control rounded" id="revisiTextarea{{ $kegiatan->id }}" name="revisi" rows="4"
                                                                style="resize: none; width: 95%;" placeholder="Beritahu peserta apa yang perlu direvisi" readonly>{{ $kegiatan->revisi }}</textarea>
                                                        </div>
                                                    </div>
                                ...
                                {{-- <td class="text-center">
                                    <form action="/dashboard/kegiatan-admin/kegiatan-magang/{{ $kegiatan->id }}/status"
