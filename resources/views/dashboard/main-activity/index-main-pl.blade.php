                        ...
                        @foreach ($users as $key => $user)
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    ...
                                    <a href="/dashboard/kegiatan-pembimbing/detail-magang/{{ $user->id }}"
                                        class="btn btn-info mr-1">
                                        <i class="bi bi-eye"></i> Detail Magang
                                    </a>
                                    <!-- Tombol Kegiatan Harian -->
                                    <a href="/dashboard/kegiatan-pembimbing/kegiatan-magang/{{ $user->id }}"
                                        class="btn btn-success">
                                        <i class="bi bi-calendar-check"></i> Kegiatan Harian
                                    </a>
                                    <!-- Tombol Absensi Harian -->
                                    <a href="/dashboard/absensi-pembimbing/{{ $user->id }}"
