...
@section('container')
    ...
    <div class="card">
        <div class="card-body">
            ...
            {{-- <a href="/dashboard/buat-jadwal-peserta" class="btn mb-2 btn-success"><i class="bi bi-plus-circle"></i>
                Tambah
                Data Jadwal</a> --}}
            <a href="/dashboard/report-jadwal-peserta" class="btn mb-2 btn-dark">
                    ...
                    <tbody>
                        @foreach ($jadwal as $key => $data)
                            <tr>
                                ...
                                <td>
                                    <a href="/dashboard/edit-jadwal-peserta/{{ $data->id }}"
                                        class="btn btn-sm btn-warning">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <form action="/dashboard/jadwal-peserta/{{ $data->id }}" method="POST"
