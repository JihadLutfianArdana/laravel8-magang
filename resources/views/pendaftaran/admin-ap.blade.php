    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-start align-items-center mb-3 mt-3">
                <a href="/dashboard/pendaftaran-peserta/laporan-persetujuan-magang/admin-pendaftaran?tanggal_awal_persetujuan={{ request('tanggal_awal_persetujuan') }}&tanggal_akhir_persetujuan={{ request('tanggal_akhir_persetujuan') }}"
                    class="btn btn-dark" target="_blank">
                    <i class="bi bi-printer"></i> Cetak Data
                </a>

                <form action="/dashboard/pendaftaran-peserta/admin-pendaftaran" method="GET" class="form-inline ml-3">
                        ...
                        @foreach ($pendaftaranPesertas as $peserta)
                            <tr>
                                ...
                                <td class="text-center align-middle">
                                    <a href="/dashboard/pendaftaran-peserta/surat-balasan/admin-pendaftaran/{{ $peserta->id }}"
    ...
    <div class="card mt-4">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-start align-items-center mb-3">
                <a href="/dashboard/pendaftaran-peserta/laporan-surat-balasan/admin-pendaftaran?tanggal_awal_balasan={{ request('tanggal_awal_balasan') }}&tanggal_akhir_balasan={{ request('tanggal_akhir_balasan') }}"
                    class="btn btn-dark" target="_blank">
                    <i class="bi bi-printer"></i> Cetak Data
                </a>
