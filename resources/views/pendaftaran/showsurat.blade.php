...
@section('container')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <a href="/dashboard/pendaftaran-peserta" class="btn mb-1 btn-secondary"><i class="bi bi-arrow-left"></i>
                Kembali</a>
            <form action="/dashboard/pendaftaran-peserta/surat-balasan/{{ $peserta->id }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <a href="/dashboard/surat-balasan/print/{{ $peserta->id }}" class="btn btn-secondary"><i
